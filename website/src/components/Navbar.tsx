...
export default function Navbar() {
    ...
    return (
        <nav className="flex items-center justify-between px-8 py-4 w-full sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 transition-all">
